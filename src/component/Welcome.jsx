...
const Welcome = () => {
  ...
  const getKui = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5011/kuisioner/data/baru"
      );
  ...
  return (
    <div>
      <div className="w-full h-full md:flex md:flex-col md:justify-between">
        <div className="md:py-10 md:pl-10 md:pr-4 md:border-b md:border-gray-200">
          <h6 className="text-blue-800 font-bold">Beranda</h6>
          <h1 className="text-3xl font-bold text-gray-800">
            Emosi Manusia Terhadap Dampak Teknologi AI Bulan Agustus 2024
          </h1>
          <div className="mt-10 flex flex-wrap justify-between md:flex md:flex-row md:mt-0">
            <button
        ...
        <div className="md:flex md:items-start md:mt-5">
          {activeTab === "grafik" && (
          ...
          <div className="md:w-1/2 md:pl-5">
            <div className="mt-12">
              <div className="flex bg-blue-500 p-4 rounded-t-lg justify-center">
                <h1 className="text-white font-bold text-xl">Isi Kuesioner</h1>
              </div>
            ...
            <div className=" mt-5">
              ...
              <div className="bg-white p-4 shadow-lg rounded-b-lg"></div>
            </div>
          </div>
        </div>
      </div>
